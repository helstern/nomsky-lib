...
class EndOptionalItemAction implements VisitAction
{
    /** @var OptionalItem */
    ...
    public function __construct(OptionalItem $expression, HierarchyVisitor $visitor)
    {
    ...
    public function execute()
    {
        ...
        $this->visitor->endVisitOptionalItem($this->expression);
        $this->executed = true;
